    ...
    <div className="flex-1 pb-24">
      <div className="py-4">
        <div className="px-4 mb-4">
          <h2 className="text-lg font-bold text-white">ブックマーク</h2>
          <p className="text-sm text-slate-400 mt-1">保存した記事: {bookmarks.length}件</p>
        </div>
        ...
        {bookmarks.length === 0 ? (
          <div className="mx-4 p-8 rounded-xl bg-slate-800/50 border border-slate-700/50 text-center">
            ...
            <p className="text-slate-400">ブックマークした記事はありません</p>
            <p className="text-slate-500 text-sm mt-1">気になる記事をブックマークして保存しましょう</p>
          </div>
        ) : (
          <div>

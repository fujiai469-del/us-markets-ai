  ...
  return (
    <div className="mx-4 mb-4 rounded-2xl bg-slate-800/80 overflow-hidden gradient-border shadow-lg shadow-black/20">
      ...
      <div className="p-4">
        ...
        <h2 className="text-lg font-bold text-white mb-3 line-clamp-2">{article.title}</h2>
          ...
          <div className="mb-3 p-3 rounded-xl bg-slate-700/50 border border-slate-600/50">
            ...
            {analysis.impact && (
              <p className="text-sm text-slate-400 mt-2">
                <span className="text-cyan-400">投資への影響:</span> {analysis.impact}
              </p>
            )}
          </div>
        )}
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 py-2.5 px-4 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-semibold disabled:opacity-50 transition-all duration-200 hover:shadow-lg hover:shadow-cyan-500/20"
          >
            {isAnalyzing ? (
